...
public class EqualsTesterLinear extends AbstractTester {

    ObjectGeneratorLinear objectGeneratorLinear;

    public EqualsTesterLinear() {
      this(DefaultFieldValueChanger.INSTANCE);
    }

    public EqualsTesterLinear(final AbstractFieldValueChanger abstractFieldValueChanger) {
    ...
    private void shouldNotEqualWithGivenFields(final ClassAndFieldPredicatePair baseClassAndFieldPredicatePair,
                                               final ClassAndFieldPredicatePair... classAndFieldPredicatePairs) {
        final List<Object> differentObjects = objectGeneratorLinear.generateDifferentObjects(baseClassAndFieldPredicatePair,
