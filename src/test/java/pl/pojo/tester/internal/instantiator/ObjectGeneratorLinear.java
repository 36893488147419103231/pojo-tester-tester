...
import pl.pojo.tester.internal.utils.FieldUtilsLinear;
...
public class ObjectGeneratorLinear {

    private static final Logger LOGGER = LoggerFactory.getLogger(ObjectGeneratorLinear.class);
    ...
    public ObjectGeneratorLinear(final AbstractFieldValueChanger abstractFieldValueChanger,
    ...
    private List<Object> generateDifferentObjects(final int level,
        ...
        final List<Field> baseClassFieldsToChange = FieldUtils
            .getFields(baseClass, baseClassFieldPredicate);
        ...
        final List<List<Field>> baseObjectFieldsPermutations = FieldUtilsLinear.sequences(baseClassFieldsToChange);
            ...
            for (final Field permutationField : eachBaseObjectFieldsPermutation) {
                ...
                if (nestedFieldsToChangeInFieldType == null || permutationFieldType.equals(baseClass)) {
                    ...
                    if (Objects.deepEquals(newFieldTypeInstance,
                                           FieldUtils
                                               .getValue(baseObjectCopy, permutationField))) {
                    ...
                    if (dejaVu.containsKey(permutationFieldType)) {
                        ...
                        final Predicate<String> fieldPredicate = userDefinedClassAndFieldPredicatePairsMap.get(
                                permutationFieldType);
                        final List<Field> fieldClassFields = FieldUtils
                            .getFields(permutationFieldType, fieldPredicate);
    ...
    private List<Object> generateDifferentObjects(final Class<?> clazz, final List<Field> fieldsToChange) {
        ...
        final List<List<Field>> permutationOfFields = FieldUtilsLinear.sequences(fieldsToChange);
